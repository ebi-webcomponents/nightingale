...
6. Create the file where the code of your custom element will be. In our example `src/nightingale-hello.ts`.
   ...
   2. The above example inherits from [LitElement](https://lit.dev/docs/api/LitElement/), while there is a base element for any Nightingale component named `NightingaleElement`.
      ...
      For instance, `NightingaleHello` needs to use margin and highlight mixins, it is inherited as follows:
