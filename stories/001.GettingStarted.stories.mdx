...
Using a component is as easy as importing it in to your HTML and using it like you
...
<script type="module">
  ...
  const track = document.querySelector("#my-nightingale-sequence-id");
  track.data = "SEQUENCESEQUENCESEQUENCESEQUENCE";
</script>
<nightingale-sequence
  width="800"
  height="40"
