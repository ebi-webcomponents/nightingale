import { NightingaleTrackDatum } from "@nightingale-elements/nightingale-track";
...
export declare const transformData: (
  data: APIFeature[]
) => (NightingaleTrackDatum & APIFeature)[];

declare class NightingaleFeatureAdapter extends NightingaleElement {
  manager: any;
