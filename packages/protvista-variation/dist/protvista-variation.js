...
function processVariants(variants, sequence) {
    ...
    try {
        for (var _iterator = variants[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            ...
            variant.sourceType = variant.sourceType ? variant.sourceType.toLowerCase() : variant.sourceType;
...
var ProtvistaVariation = function (_HTMLElement) {
    inherits(ProtvistaVariation, _HTMLElement);

    function ProtvistaVariation() {
        classCallCheck(this, ProtvistaVariation);
        ...
        _this.displayStart = _this.getAttribute('displaystart') ? _this.getAttribute('displaystart') : 0;
        _this._highlightEnd = parseInt(_this.getAttribute('highlightend')) ? parseInt(_this.getAttribute('highlightend')) : 0;
        _this._highlightStart = parseInt(_this.getAttribute('highlightstart')) ? parseInt(_this.getAttribute('highlightstart')) : 0;
        _this._highlightEnd = parseInt(_this.getAttribute('highlightend')) ? parseInt(_this.getAttribute('highlightend')) : 0;
        ...
        _this._selectedFilters = getFiltersFromAttribute(_this.getAttribute('variantfilters'));
        _this._margin = {
            top: 20,
            right: 10,
            bottom: 10,
    ...
    createClass(ProtvistaVariation, [{
        ...
        value: function connectedCallback() {
            ...
            this.addEventListener('load', function (d) {
                ...
                _this2.displayEnd = _this2.getAttribute('displayend') ? _this2.getAttribute('displayend') : _this2._length;
                ...
                if (_this2.displayStart && _this2.displayEnd) {
        ...
        value: function applyZoomTranslation() {
            ...
            this._svg.transition().duration(300).call(this._zoom.transform, identity$8.translate(-(this._xScale(this.displayStart) * this._scale) + this._margin.left, 0).scale(this._scale));
        }
    }, {
        key: 'renderChart',
        ...
        get: function get() {
            return ['displaystart', 'displayend', 'scale', 'highlightStart', 'highlightEnd', 'variantfilters', 'width'];
        }
    }]);
...
//# sourceMappingURL=protvista-variation.js.map
