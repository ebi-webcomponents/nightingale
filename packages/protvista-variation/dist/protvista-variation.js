...
var _templateObject2 = taggedTemplateLiteral(['\n                    <li><label><input type="checkbox" id="', '-filter"/><span class="filter-select" style="background-color: ', '"></span>', '</label></li>\n                '], ['\n                    <li><label><input type="checkbox" id="', '-filter"/><span class="filter-select" style="background-color: ', '"></span>', '</label></li>\n                ']);
var _templateObject3 = taggedTemplateLiteral(['\n                    <li><label><input type="checkbox" id="', '-filter"/></span>', '</label></li>\n                '], ['\n                    <li><label><input type="checkbox" id="', '-filter"/></span>', '</label></li>\n                ']);
    ...
    createClass(ProtVistaVariationFilters, [{
        ...
        value: function renderFilters() {
            ...
            filters.map(function (filter) {
                return _this2.querySelectorAll('#' + filter.name + '-filter')[0].addEventListener('change', function (e) {
