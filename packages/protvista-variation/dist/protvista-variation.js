    ...
    createClass(ProtvistaVariation, [{
        ...
        value: function connectedCallback() {
            ...
            this.addEventListener('load', function (d) {
                ...
                if (_this2.displayStart && _this2.scale) {
        ...
        value: function applyZoomTranslation() {
            this._svg.transition().duration(300).call(this._zoom.transform, identity$8.translate(-(this._xScale(this.displayStart) * this.scale) + this._margin.left, 0).scale(this.scale));
        }
    }, {
        key: 'renderChart',
