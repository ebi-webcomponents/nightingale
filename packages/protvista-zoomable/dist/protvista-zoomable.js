var ProtvistaZoomable = (function () {
'use strict';
...
var ProtvistaZoomable$1 = function (_HTMLElement) {
    ...
    createClass(ProtvistaZoomable, [{
        ...
        value: function updateScaleDomain() {
            this.xScale = linear$2().domain([1, this._length + 1]).range([this._margin.left, this._width - this._margin.right]);
        }
    }, {
        key: 'initZoom',
        value: function initZoom() {
            this._zoom = zoom().scaleExtent([1, 40]).translateExtent([[0, 0], [this.width, 100]]).on("zoom", this.zoomed.bind(this));
        }
    }, {
        key: 'zoomed',
        value: function zoomed() {
            this.xScale = event.transform.rescaleX(this._orignXScale);
            this.refresh();
        }
    }, {
        ...
        value: function applyZoomTranslation() {
            ...
            this._svg.transition().duration(300).call(this._zoom.transform, identity$8.translate(-(this._xScale(this.displayStart) * this._zoomScale) + this._margin.left, 0).scale(this._zoomScale));
            this.refresh();
        }
    }, {
        key: 'displayStart',
