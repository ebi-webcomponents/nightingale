var wc = (function (d3) {
    ...
    class ProtvistaZoomable extends HTMLElement {
      ...
      initZoom() {
        this._zoom = d3.zoom().scaleExtent([1, Infinity]).translateExtent([[0, 0], [this.width, 0]]).on("zoom", this.zoomed);
      }
      ...
      applyZoomTranslation() {
        ...
        this.svg.call(this.zoom.transform, d3.zoomIdentity.scale(k).translate(dx, 0));
