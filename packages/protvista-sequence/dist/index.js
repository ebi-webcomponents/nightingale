var wc = (function (ProtvistaZoomable) {
  'use strict';
  ...
  class ProtVistaSequence extends ProtvistaZoomable {
    ...
    _createSequence() {
      super.svg = select$2(this).append('div').attr('class', '').append('svg').attr('id', '').attr('width', this.width).attr('height', height);
    ...
    refresh() {
      if (this.axis) {
        ...
        this.xAxis = axisBottom(this.xScale).tickFormat(d => Number.isInteger(d) ? d : '');
