...
const sparqlLoader = {
  ...
  loadData: function(entry) {
    ...
    var promiseEdges = new Promise(function(resolve, reject) {
      var url = `http://sparql.uniprot.org/sparql?query=PREFIX+up%3a%3Chttp%3a%2f%2fpurl.uniprot.org%2fcore%2f%3E+%0d+PREFIX+uniprotkb%3a%3Chttp%3a%2f%2fpurl.uniprot.org%2funiprot%2f%3E+%0d+SELECT+%3fsource+%3ftarget+%3fexp%0d+WHERE%0d+%7b%0d+BIND(uniprotkb%3a${entry}+as+%3fprotein)%0d+%7b+%0d+%3fprotein+up%3ainteraction+%3finter+.%0d+%3finter+a+up%3aSelf_Interaction+%3b%0d+up%3aexperiments+%3fexp+.%0d+BIND(%3fprotein+AS+%3fsource_entry)%0d+BIND(%3fprotein+AS+%3ftarget_entry)%0d+%7d+UNION+%7b%0d+%3fprotein+up%3ainteraction+%3finter+.%0d+%3finter+a+up%3aNon_Self_Interaction+%3b%0d+up%3aexperiments+%3fexp+%3b%0d+up%3aparticipant%2fowl%3asameAs+%3fprotein+%2c%3ftarget_entry+.%0d+FILTER(!sameTerm(%3fprotein%2c+%3ftarget_entry)) BIND(?protein AS ?source_entry)%0d+%7d+UNION+%7b%0d+%3fprotein+up%3ainteraction+%3finter1+.%0d+%3finter1+a+up%3aNon_Self_Interaction+%3b%0d+up%3aparticipant%2fowl%3asameAs+%3fsource_entry+.%0d+%3fsource_entry+up%3ainteraction+%3finter2+.%0d+%3finter2+up%3aexperiments+%3fexp+%3b%0d+up%3aparticipant%2fowl%3asameAs+%3fsource_entry%2c+%3ftarget_entry+.%0d+FILTER(!sameTerm(%3fsource_entry%2c+%3fprotein))%0d+FILTER(!sameTerm(%3ftarget_entry%2c+%3fprotein))+%0d+%7d%0d+BIND+(STRAFTER(SUBSTR(STR(%3fsource_entry)%2c+32)%2c%27%2f%27)+as+%3fsource)%0d+BIND+(STRAFTER(SUBSTR(STR(%3ftarget_entry)%2c+32)%2c+%27%2f%27)+as+%3ftarget)%0d+%7d+GROUP+BY+%3fsource+%3ftarget+%3fexp+ORDER+BY+%3fsource+%3ftarget+%3fexp&format=srj`;
      d3.json(url, data => {
        resolve(data);
      });
    });
