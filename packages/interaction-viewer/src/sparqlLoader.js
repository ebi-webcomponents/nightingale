...
const sparqlLoader = {
    ...
    loadData: function(entry) {
      ...
      var promiseEdges = new Promise(function(resolve, reject){
        var url = `http://sparql.uniprot.org/sparql?query=PREFIX+rdf%3a%3Chttp%3a%2f%2fwww.w3.org%2f1999%2f02%2f22-rdf-syntax-ns%23%3E+%0d%0aPREFIX+up%3a%3Chttp%3a%2f%2fpurl.uniprot.org%2fcore%2f%3E+%0d%0aPREFIX+uniprotkb%3a%3Chttp%3a%2f%2fpurl.uniprot.org%2funiprot%2f%3E%0d%0aPREFIX+owl%3a%3Chttp%3a%2f%2fwww.w3.org%2f2002%2f07%2fowl%23%3E%0d%0aSELECT+%3fsource+%3ftarget%0d%0a(SUM(%3fexperiment)+as+%3fexperiments)%0d%0aWHERE%0d%0a%7b%0d%0a+++BIND(uniprotkb%3a${entry}+as+%3fentry)%0d%0a+++%7b%0d%0a+++++BIND(%3fentry+as+%3fsource_participant)++%0d%0a+++++%3fsource_participant+up%3ainteraction+%3finteraction+.%0d%0a+++++%3finteraction+up%3aparticipant%2fowl%3asameAs+%3ftarget_participant+.%0d%0a+++++%3finteraction+up%3aexperiments+%3fexperiment+.%0d%0a+++%7d+UNION+%7b%0d%0a+++++%3fentry+up%3ainteraction+%3finteraction+.%0d%0a+++++%3finteraction+up%3aparticipant%2fowl%3asameAs+%3fsource_participant+.%0d%0a+++++FILTER+(!+(%3fsource_participant+IN+(%3fentry)))%0d%0a+++++%3fsource_participant+up%3ainteraction+%3fsecond_interaction+.%0d%0a+++++%3fsecond_interaction+up%3aparticipant%2fowl%3asameAs+%3ftarget_participant+.%0d%0a+++++%3fentry+up%3ainteraction%2fup%3aparticipant%2fowl%3asameAs+%3ftarget_participant+.%0d%0a+++++FILTER+(!sameTerm(%3ftarget_participant%2c%3fentry))%0d%0a+++++%3fsecond_interaction+up%3aexperiments+%3fexperiment+.%0d%0a+++%7d%0d%0a+++BIND+(SUBSTR(STR(%3fsource_participant)%2c+33)+as+%3fraw_source)+%0d%0a+++BIND+(SUBSTR(STR(%3ftarget_participant)%2c+33)+as+%3fraw_target)%0d%0a+++BIND(IF+(strstarts(%3fraw_source%2c+%27%2f%27)%2c+substr(%3fraw_source%2c+2)%2c%3fraw_source)+AS+%3fsource)%0d%0a+++BIND(IF+(strstarts(%3fraw_target%2c+%27%2f%27)%2c+substr(%3fraw_target%2c+2)%2c%3fraw_target)+AS+%3ftarget)%0d%0a%7d+GROUP+BY+%3fsource+%3ftarget+ORDER+BY+%3fsource+%3ftarget&format=srj`;
        d3.json(url, data => {
          resolve(data);
        });
      });
