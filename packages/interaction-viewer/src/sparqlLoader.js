  ...
  processData: function(accession, nodeData, edgeData) {
    ...
    for (element of nodeData.results.bindings) {
      var node = {
        ...
        'intact' : [element.intact_accessions.value]
      };
