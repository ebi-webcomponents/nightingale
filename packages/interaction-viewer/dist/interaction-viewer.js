 ...
 * // => true
 */function Un(e){return An(e,Fl)}function Mn(e){return fetch('https://www.ebi.ac.uk/proteins/api/proteins/interaction/'+e+'.json').then(function(e){return e.json().then(function(e){return Fn(e)})})}function Fn(e){e=e.map(function(e){return e.interactions||(e.interactions=[]),e});// Add symmetry if required
