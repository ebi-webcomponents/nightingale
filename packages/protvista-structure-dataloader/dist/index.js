var wc = (function (UniProtEntryDataAdapter) {
  'use strict';

  UniProtEntryDataAdapter = UniProtEntryDataAdapter && UniProtEntryDataAdapter.hasOwnProperty('default') ? UniProtEntryDataAdapter['default'] : UniProtEntryDataAdapter;
  ...
  class StructureDataParser {
    ...
    _parseValidEntry(data) {
      ...
      this._pdbFeatures.features = map(structures, structure => {
  ...
  /*jslint node: true */
  class ProtVistaStructureAdapter extends UniProtEntryDataAdapter {
    constructor() {
      super();
